...
#checkpoint_d1 = torch.load(cfg.d1_load)
d1 = D1().to(device)
#d1.load_state_dict(checkpoint_d1['model_state_dict'])

#checkpoint_d2 = torch.load(cfg.d2_load)
d2 = D2().to(device)
#d2.load_state_dict(checkpoint_d2['model_state_dict'])
...
for epoch in range(cfg.epoch):
    ...
    print("[Epoch:%d] [D loss:%f] [G loss:%f]" % ((epoch+1), d_running_loss, g_running_loss))
