...
aug_celebA = cfg.Augmented_CelebA(cfg.celebA_root, cfg.transform_pretrain)
#augment_loader = DataLoader(aug_celebA, batch_size=cfg.pre_batch_size, shuffle=True, pin_memory=True)
augment_loader = DataLoader(aug_celebA, batch_size=cfg.pre_batch_size, shuffle=True, pin_memory=True)
