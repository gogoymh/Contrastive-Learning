...
encoder.eval()
generator.eval()
fake_sample = generator(z_sample.view(25, -1))
save_image(fake_sample.data, "C://유민형//개인 연구//Constrastive learning//sample2//epoch_0.png", nrow=5, normalize=True)
...
for epoch in range(20):
    ...
    for i in range(batch_num):
        ...
        rep1 = encoder(generator(z1.view(batch_size,-1)))
        rep2 = encoder(generator(z2.view(batch_size,-1)))
...
for epoch in range(200):
    ...
    for i in range(batch_num):
        ...
        ###############################################################################################
        real, _ = cifar_loader.__iter__().next()
    ...
    if (epoch+1) % 1 == 0:
        ...
        save_image(fake_sample.data, "C://유민형//개인 연구//Constrastive learning//sample2//epoch_%d.png" % (epoch+1), nrow=5, normalize=True)
