...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.normalize(self.fc(out), dim=1)
...
encoder.eval()
generator.eval()
fake_sample = generator(encoder(z_sample.view(25, -1)))
...
for epoch in range(100):
    ...
    for i in range(batch_num):
        ...
        rep1 = encoder(z1.view(batch_size,-1))
        rep2 = encoder(z2.view(batch_size,-1))
...
for epoch in range(200):
    ...
    for i in range(batch_num):
        ...
        fake = generator(encoder(z.view(batch_size,-1)))
