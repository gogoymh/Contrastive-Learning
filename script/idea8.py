...
pre_train = True
pre_test_idx = None #1
pretrained_path = None #"/home/compu/ymh/contrastive/test" + str(pre_test_idx) + ".pth"
batch_num = 60000//pre_batch_size if pre_train else 202599//batch_size
...
augmented_latent = Augmented_latent(transform=transform_latent)
latent_loader = DataLoader(dataset=augmented_latent, batch_size=pre_batch_size, shuffle=True, pin_memory=True)
...
if pre_train:
    ...
    for epoch in range(1000):
        ...
        for i in range(batch_num):
            ...
            z1, z2 = latent_loader.__iter__().next()
            ...
            rep1 = encoder(generator(z1.view(pre_batch_size, latent_dim, 1, 1)))
            rep2 = encoder(generator(z2.view(pre_batch_size, latent_dim, 1, 1)))
    ...
    model_name = "/home/compu/ymh/contrastive/test" + str(test_idx) + ".pth"
    #model_name = "/DATA/ymh/mobius/test" + str(test_idx) + "_pretrained.pth"
    #model_name = "/data1/ymh/mobius/test" + str(test_idx) + "cycle" + str(cycle) + ".pth"
    ...
    for epoch in range(200):
        ...
        for i in range(batch_num):
            ...
            z = torch.from_numpy(np.random.normal(0, 1, (batch_size, 10, 10, 1)))
            z = z.float().to(device)    
