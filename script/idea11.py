...
if pre_train:
    ...
    optim_pre_D2 = LARS(optim.SGD(decoder.parameters(), lr=0.1))
    ...
    for epoch in range(1000):
        ...
        for i in range(batch_num):
            ...
            optim_pre_D2.zero_grad()
            
            fake1 = generator(z1)
            fake2 = generator(z2)
                        
            out1 = discriminator(fake1)
            out2 = discriminator(fake2)
        ...
        if (epoch+1) % 10 == 0:
            ...
            model_name_decoder = "/home/compu/ymh/contrastive/test" + str(test_idx) + "decoder.pth"
            #model_name_encoder = "/DATA/ymh/contrastive/test" + str(test_idx) + "encoder.pth"
            torch.save({'model_state_dict': decoder.state_dict()}, model_name_decoder)
